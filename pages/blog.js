...
export default function Blog() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle={<>Blog & <span>Article</span></>}>
                                ...
                                <div className="blog-tav-wrap">
                                    <ul className="nav nav-tabs" id="myTab" role="tablist">
                                        <li className="nav-item" onClick={() => handleOnClick(1)}>
                                            <button className={activeIndex == 1 ? "nav-link active" : "nav-link"}>Community</button>
                                        </li>
                                        <li className="nav-item" onClick={() => handleOnClick(2)}>
                                            <button className={activeIndex == 2 ? "nav-link active" : "nav-link"}>Ai Technology</button>
                                        </li>
                                        <li className="nav-item" onClick={() => handleOnClick(3)}>
                                            <button className={activeIndex == 3 ? "nav-link active" : "nav-link"}>Developers</button>
                                        </li>
                                        <li className="nav-item" onClick={() => handleOnClick(4)}>
                                            <button className={activeIndex == 4 ? "nav-link active" : "nav-link"}>Announcements</button>
                                        </li>
                                        <li className="nav-item" onClick={() => handleOnClick(5)}>
                                            <button className={activeIndex == 5 ? "nav-link active" : "nav-link"}>video Library</button>
                                        </li>
                                    </ul>
                                                    ...
                                                    <div className="col-12">
                                                        <div className="blog-item">
                                                            <div className="blog-content">
                                                                ...
                                                                <h2 className="title"><Link href="/blog-details">Will I get caught using ChatGPT for my homework? Here's how to prevent AI detection</Link></h2>
