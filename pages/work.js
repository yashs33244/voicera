...
export default function Work() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle={<>How it’s <span>Work</span></>}>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                ...
                                <div className="work-item" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                                    ...
                                    <div className="work-content">
                                        <span>Step 2</span>
                                        <h2 className="title">How AI Became Our Greatest Co-Worker</h2>
                                ...
                                <div className="work-item" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                                    ...
                                    <div className="work-content">
                                        <span>Step 3</span>
                                        <h2 className="title">Inspiration to Creation the Creative Art Maker</h2>
