...
export default function BlogDetails() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle={<>Blog   <span>Details</span></>}>
                                ...
                                <div className="related-post-wrap">
                                    ...
                                    <Slider {...settings} className="row related-post-active">
                                        <div className="col-lg-4">
                                            <div className="blog-grid-item">
                                                ...
                                                <div className="blog-grid-content">
                                                    <span className="date">March 24, 2023</span>
                                                    <h2 className="title"><Link href="/blog-details">The Future of Document Writing Introducing the Dex.ai</Link></h2>
                                        ...
                                        <div className="col-lg-4">
                                            <div className="blog-grid-item">
                                                ...
                                                <div className="blog-grid-content">
                                                    ...
                                                    <h2 className="title"><Link href="/blog-details">Unlock Your Writing Potential with Dex.ai Boost SEO</Link></h2>
                                        ...
                                        <div className="col-lg-4">
                                            <div className="blog-grid-item">
                                                ...
                                                <div className="blog-grid-content">
                                                    ...
                                                    <h2 className="title"><Link href="/blog-details">How to Use Dex.ai for Generating High SEO Ranking</Link></h2>
                                        ...
                                        <div className="col-lg-4">
                                            <div className="blog-grid-item">
                                                <div className="blog-grid-thumb">
                                                    <Link href="/blog-details"><img src="assets/img/blog/blog_img05.jpg" alt="" /></Link>
                                                </div>
                                                <div className="blog-grid-content">
                                                    <span className="date">August 31, 2023</span>
                                                    <h2 className="title"><Link href="/blog-details">How to Generate Engaging Content Ideas Quickly with</Link></h2>
                                                ...
                                                <div className="comments-box">
                                                    ...
                                                    <div className="comments-text">
                                                        <div className="avatar-name">
                                                            <h6 className="name">
                                                                by Benjamin / <span className="date">September 28, 2023</span>
                                                            </h6>
                                                        </div>
                                                        ...
                                                        <ul className="list-wrap">
                                                            <li className="like"><Link href="#">like</Link></li>
                                                            <li className="reply"><Link href="#">reply</Link></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                    ...
                                                    <li>
                                                        <div className="comments-box">
                                                            ...
                                                            <div className="comments-text">
                                                                <div className="avatar-name">
                                                                    <h6 className="name">
                                                                        by Thomas / <span className="date">September 30, 2023</span>
                                                                    </h6>
                                                                </div>
