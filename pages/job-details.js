...
export default function JobDetails() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle={<>Job <span>Details</span></>}>
                <section className="job-details-area pb-150">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-10">
                                <div className="job-details-content">
                                    <h2 className="title">Senior Software Engineer - (Full-Time)</h2>
                                    ...
                                    <div className="job-details-list-wrap">
                                        <h2 className="title-two">Your experience should include...</h2>
                                        <ul className="list-wrap">
                            ...
                            <div className="col-lg-12">
                                <div className="job-apply-form-wrap">
                                    <form action="#" className="apply-form">
                                        ...
                                        <div className="form-grp">
                                            <label htmlFor="posting">Which job posting are you applying for ? *</label>
                                            <input type="text" id="posting" />
                                        </div>
                                        <div className="form-grp">
                                            <label htmlFor="opening">From where you have heard about the job opening? *</label>
