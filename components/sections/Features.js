...
export default function Features() {
    return (
        <>
            <div className="features-area features-bg" data-background="/assets/img/bg/features_bg.png">
                ...
                <div className="features-shape-wrap">
                    ...
                    <img src="/assets/img/images/features_shape02.png" alt="" className="alltuchtopdown" />
