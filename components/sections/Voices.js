                                                ...
                                                <div className="vioces-item">
                                                    ...
                                                    <div className="vioces-content">
                                                        ...
                                                        <ul className="list-wrap">
                                                            <li><Link href="#">Confident</Link></li>
                                                            <li><Link href="#">Bold</Link></li>
                                                            <li><Link href="#">Authoritative</Link></li>
                                                            <li><Link href="#">Bossy</Link></li>
                                                            <li><Link href="#">Charismatic</Link></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-lg-4 col-md-6 col-sm-10">
                                                <div className="vioces-item">
                                                    ...
                                                    <div className="vioces-content">
                                                        ...
                                                        <ul className="list-wrap">
                                                            <li><Link href="#">Bold</Link></li>
                                                            <li><Link href="#">Approachable</Link></li>
                                                            <li><Link href="#">Commanding</Link></li>
                                                            <li><Link href="#">Heroic</Link></li>
                                                            <li><Link href="#">Tough</Link></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-lg-4 col-md-6 col-sm-10">
                                                <div className="vioces-item">
                                                    ...
                                                    <div className="vioces-content">
                                                        ...
                                                        <ul className="list-wrap">
                                                            <li><Link href="#">Reassuring</Link></li>
                                                            <li><Link href="#">Approachable</Link></li>
                                                            <li><Link href="#">Bossy</Link></li>
                                                            <li><Link href="#">Attentive</Link></li>
                                                            <li><Link href="#">Charismatic</Link></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="col-lg-4 col-md-6 col-sm-10">
                                                <div className="more-vioces-item">
                                                    ...
                                                    <div className="more-vioces-content">
                                                        ...
                                                        <Link href="/login" className="gradient-btn gradient-btn-four">TRY NOW FOR FREE</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row justify-content-center">
                                            ...
                                            <div className="col-lg-4 col-md-6 col-sm-10">
                                                <div className="more-vioces-item">
                                                    ...
                                                    <div className="more-vioces-content">
                                                        <p>To get more voices, you can instantly clone any voice with just 3 seconds of audio</p>
                                                        <Link href="/contact" className="gradient-btn gradient-btn-four">TRY NOW FOR FREE</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
