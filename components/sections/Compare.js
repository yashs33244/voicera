                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-7 col-lg-8">
                            <div className="section-title-two text-center mb-70">
                                <h2 className="title">Say goodbye to expensive
                                    <span>traditional
                                        <strong>
                                            video creation
                                            <svg viewBox="0 0 345 23" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
                                                <path fillRule="evenodd" clipRule="evenodd" d="M344.366 0.00527191C231.51 16.2892 117.803 18.0623 5.82257 7.9456C3.59842 7.74418 0.292572 9.4891 0.0174561 12.1809C-0.260559 14.9221 2.83823 17.0748 5.06818 17.301C117.89 28.79 231.159 22.6085 344.545 1.4609C345.266 1.32606 345.074 -0.0971813 344.366 0.00527191Z" fill="url(#compare)" />
                                                <defs>
                                                    <linearGradient id="compare" x1="376.061" y1="0.000463246" x2="10.2776" y2="101.79" gradientUnits="userSpaceOnUse">
