                        ...
                        <div className="col-lg-5">
                            <div className="use-cases-content">
                                <div className="section-title mb-25">
                                    <h2 className="title title-animation">AI Does it <span>faster</span>  better.</h2>
                                </div>
                            ...
                            <div className="use-cases-nav-wrap">
                                <ul className="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li className="nav-item" onClick={() => handleOnClick(2)}>
                                        <button className={activeIndex == 2 ? "nav-link active" : "nav-link"}>Social Media</button>
                                    </li>
                                    <li className="nav-item" onClick={() => handleOnClick(3)}>
                                        <button className={activeIndex == 3 ? "nav-link active" : "nav-link"}>Emails</button>
                                    </li>
                                    <li className="nav-item" onClick={() => handleOnClick(4)}>
                                        <button className={activeIndex == 4 ? "nav-link active" : "nav-link"}>Code</button>
                                    </li>
                                    <li className="nav-item" onClick={() => handleOnClick(5)}>
                                        <button className={activeIndex == 5 ? "nav-link active" : "nav-link"}>Art</button>
                                    </li>
                                </ul>
                                            ...
                                            <div className="cases-details-content">
                                                ...
                                                <div className="content-bottom">
                                                    <ul className="list-wrap">
                                                        <li><Link href="#"><i className="far fa-copy" /></Link></li>
                                                        <li><Link href="#"><i className="fal fa-download" /></Link></li>
                                                        <li><Link href="#"><i className="fal fa-paste" /></Link></li>
                                                        <li><Link href="#"><i className="far fa-trash-alt" /></Link></li>
                                                        <li><Link href="#"><i className="fal fa-plus-circle" /></Link></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
