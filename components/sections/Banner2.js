                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-9 col-lg-10">
                            <div className="banner-content-two">
                                <h2 className="title wow fadeInUp" data-wow-delay=".2s">Create videos from plain <br />
                                    <span>&nbsp;text&nbsp;
                                        <strong>
                                             in minutes
                                ...
                                <div className="banner-btn-two">
                                    <Link href="/work" className="gradient-btn gradient-btn-three wow fadeInLeft" data-wow-delay=".6s">create a free ai video</Link>
                                    <Link href="/work" className="btn btn-three wow fadeInRight" data-wow-delay=".6s">create a free ai video</Link>
                                </div>
                            </div>
                        </div>
                    </div>
