                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-9">
                            <div className="writing-item">
                                ...
                                <div className="writing-content">
                                    ...
                                    <Link href="/work" className="link-btn">Try Gpt-3.5 language<i className="far fa-arrow-right" /></Link>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-9">
                            <div className="writing-item">
                                ...
                                <div className="writing-content">
                                    ...
                                    <p>Unlike anything you've experienced - unique and unimaginable capabilities.</p>
                                    <Link href="/work" className="link-btn">Try use of AI<i className="far fa-arrow-right" /></Link>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-9">
                            <div className="writing-item">
                                ...
                                <div className="writing-content">
                                    ...
                                    <p>Unlike anything you've experienced - unique and unimaginable capabilities.</p>
                                    <Link href="/work" className="link-btn">Try conversions<i className="far fa-arrow-right" /></Link>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-9">
                            <div className="writing-item">
                                ...
                                <div className="writing-content">
                                    ...
                                    <p>Unlike anything you've experienced - unique and unimaginable capabilities.</p>
                                    <Link href="/work" className="link-btn">Try supports languages<i className="far fa-arrow-right" /></Link>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-9">
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 col-sm-9">
                            <div className="writing-item">
                                ...
                                <div className="writing-content">
                                    ...
                                    <p>Unlike anything you've experienced - unique and unimaginable capabilities.</p>
                                    <Link href="/work" className="link-btn">Try powerful settings<i className="far fa-arrow-right" /></Link>
                                </div>
                            </div>
                        </div>
                    </div>
